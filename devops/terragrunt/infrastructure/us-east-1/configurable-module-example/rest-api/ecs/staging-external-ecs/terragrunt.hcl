...
locals {
  ...
  cluster_arn = "arn:aws:ecs:us-east-1:456969868172:cluster/staging-external-ecs"
  vpc_id = "vpc-0c176c69"
  ...
  target_group_name = substr("staging-${local.ecs_service_name}", 0, 32)
  
  # Service hostname
  host_value = "${local.service_yaml.service_name}.stage.autoverify.services"
  ...
  environment_variables = {
    ...
    AUTH0_DOMAIN          = "stage-0k8m6aqc.us.auth0.com"
    ...
    BUGSNAG_API_KEY       = ""
    BUGSNAG_RELEASE_STAGE = "staging-external-ecs"
  }
