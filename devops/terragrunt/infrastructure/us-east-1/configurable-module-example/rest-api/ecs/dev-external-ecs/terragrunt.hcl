...
locals {
  ...
  cluster_name = "dev-external-ecs"
  cluster_arn = "arn:aws:ecs:us-east-1:456969868172:cluster/dev-external-ecs"
  vpc_id = "vpc-0c176c69"
  
  # Load balancer details
  lb_arn = "arn:aws:elasticloadbalancing:us-east-1:456969868172:loadbalancer/app/dev-ecs-external-alb/6b6be698e84c9d10"
  lb_name = "dev-ecs-external-alb"
  
  # Target group configuration
  target_group_name = substr("dev-${local.ecs_service_name}", 0, 32)
  
  # Service hostname
  host_value = "${local.service_yaml.service_name}.dev.autoverify.services"
  ...
  environment_variables = {
    ...
    AUTH0_DOMAIN          = "dev-0k8m6aqc.us.auth0.com"
    ...
    BUGSNAG_API_KEY       = ""
    BUGSNAG_RELEASE_STAGE = "dev-external-ecs"
  }
